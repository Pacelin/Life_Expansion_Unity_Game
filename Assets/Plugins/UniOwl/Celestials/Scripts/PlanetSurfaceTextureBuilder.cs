...
namespace UniOwl.Celestials
{
    public static class PlanetSurfaceTextureBuilder
    {
        ...
        private static readonly Dictionary<Type, TextureFormat> typeToTextureFormatMap = new()
        {
            { typeof(float), TextureFormat.BC4 },
            { typeof(float2), TextureFormat.BC5 },
            { typeof(float3), TextureFormat.BC7 },
            { typeof(float4), TextureFormat.BC7 },
        };
