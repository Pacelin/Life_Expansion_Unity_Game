...
namespace UniOwl.Celestials.Editor
{
    ...
    {
        private static readonly string[] physicalProperties = { "Temperature", "_Emission" };
        private static readonly string[] noiseSamplingProperties = { "Flattening", "Offset_Speed", "Warp_Speed" };
        private static readonly string[] noiseSurfaceProperties = { "Octaves", "Persistence", "Scale", "Warp_Scale" };

        private static readonly string[] noiseDetailProperties =
            { "Detail_Threshold", "Detail_Scale_Factor", "Detail_Redistribution" };
        ...
        {
            foldoutPhysical =
                EditorGUILayout.BeginFoldoutHeaderGroup(foldoutPhysical, "Physical", EditorStyles.foldoutHeader);
        ...
        {
            foldoutColoring =
                EditorGUILayout.BeginFoldoutHeaderGroup(foldoutColoring, "Coloring", EditorStyles.foldoutHeader);
        ...
        private void DisplayShaderProperties(
        ...
        private void DisplayShaderProperty(
                MaterialEditor materialEditor,
                MaterialProperty[] properties,
                string propertyName
            )
