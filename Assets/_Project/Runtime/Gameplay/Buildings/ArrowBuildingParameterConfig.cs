...
namespace Runtime.Gameplay.Buildings
{
    ...
    {
        [SerializeField] private int _positiveSmallArrowMax = 1;
        [SerializeField] private int _positiveMediumArrowMax = 2;
        [SerializeField] private int _negativeSmallArrowMin = -1;
        [SerializeField] private int _negativeMediumArrowMin = -2;
